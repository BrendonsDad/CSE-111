...
def main():
    ...
    print('Hello there, please enter the following.')
    gender = input('What is your gender. ')
    birthday = input('What is your birthday? (ex:(YYY-MM-DD) ')
    ...
    bmi = body_mass_index(weight = kilograms, height = centimeters)
    bmr = basal_metabolic_rate(gender, kilograms, centimeters, age)

    # Print the results for the user to see.
    print()
    print(f'Age (years): {age}')
    print(f'Weight (kg): {kilograms:.1f}')
    meters = centimeters / 100
    print(f'Height (cm): {meters:.2f}')
...
def basal_metabolic_rate(gender, weight, height, age):
    ...
    if gender.lower() == 'f':
        ...
        bmr = 88.362 + 13.297 * weight + 4.799 *height - 5.677 * age
