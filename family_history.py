...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        hus_value = people_dict[husband]
        wife_value= people_dict[wife]

        wife_name = wife_value[0]
        wife_birth = wife_value[2]
        wife_age = wedding_year - wife_birth

        hus_name = hus_value[0]
        hus_birth = hus_value[2]
        hus_age = wedding_year - hus_birth

        print(f'{hus_name} {hus_age} > {wedding_year} < {wife_name} {wife_age}')
